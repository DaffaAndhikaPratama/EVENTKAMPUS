    ...
    <div class="container">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0">
                <li class="breadcrumb-item"><a href="<?= BASE_URL ?>/index.php" class="text-decoration-none">Beranda</a>
                </li>
    ...
    <div class="row justify-content-center">
        <div class="col-lg-8">
            ...
            <div class="mb-4 text-center">
                <span
                    class="badge bg-primary px-3 py-2 rounded-pill mb-3"><?= htmlspecialchars($article['category']) ?></span>
            ...
            <div class="mb-5">
                <img src="https://source.unsplash.com/1200x600/?<?= urlencode($article['category']) ?>,technology"
                    class="img-fluid rounded-3 shadow-sm w-100" alt="Gambar Artikel">
            </div>
            ...
            <div class="d-flex justify-content-between">
                <a href="info_tips.php" class="btn btn-outline-secondary"><i class="bi bi-arrow-left"></i> Kembali ke
                    Daftar</a>
                <button class="btn btn-primary" onclick="window.print()"><i class="bi bi-printer"></i> Simpan
                    Artikel</button>
            </div>
