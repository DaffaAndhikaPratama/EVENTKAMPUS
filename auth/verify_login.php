...
if (isset($_POST['verify_login'])) {
    ...
    if ($userObj->verifyLogin($email, $token)) {
        echo "<script>
        ...
        <div class="col-md-5">
            <div class="card border-0 shadow-lg rounded-3">
                <div class="card-body p-4 text-center">
                    ...
                    <p class="text-muted small mb-4">Kami telah mengirim kode OTP Login ke <b><?= $email_input ?></b>.
                        Masukkan kode tersebut untuk masuk.</p>
                    ...
                    <form method="POST">
                        ...
                        <div class="mb-4">
                            <input type="text" name="token" class="form-control text-center fs-3 letter-spacing-2"
                                placeholder="000000" maxlength="6" required autofocus>
                        </div>
                        <button type="submit" name="verify_login"
                            class="btn btn-warning w-100 fw-bold py-2 text-dark">Verifikasi & Masuk</button>
                    </form>
