                ...
                <div class="col-md-8 col-lg-6">
                    <form action="#events" method="GET" class="d-flex gap-2 p-1 bg-white rounded-pill shadow-sm">
                        <input type="text" name="q" class="form-control border-0 rounded-pill ps-4 form-control-lg"
                            placeholder="Cari event (co: Seminar AI...)" value="<?= htmlspecialchars($search_q) ?>">
                ...
                <div class="col-md-4">
                    <div class="card card-event h-100 shadow-sm rounded-4">
                        ...
                        <div class="card-body">
                            ...
                            <p class="small text-muted mb-3"><i class="bi bi-geo-alt-fill text-danger"></i>
                                <?= htmlspecialchars($pop['location']) ?></p>

                            <div class="d-flex justify-content-between align-items-center pt-3 border-top">
                                <small class="fw-bold text-primary"><i class="bi bi-people-fill"></i>
                                    <?= number_format($pop['participants']) ?> Peserta</small>
                                <a href="<?= BASE_URL ?>/event_management/detail_event.php?id=<?= $pop['id'] ?>"
                                    class="btn btn-sm btn-outline-primary rounded-pill px-4">Detail</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card card-event h-100 shadow-sm rounded-4">
                        ...
                        <div class="card-body d-flex flex-column">
                            ...
                            <div class="d-flex justify-content-between align-items-center mt-3 pt-3 border-top">
                                ...
                                <a href="<?= BASE_URL ?>/event_management/detail_event.php?id=<?= $event['id'] ?>"
                                    class="btn btn-primary btn-sm rounded-pill px-4 stretched-link">
                                    Detail
                                </a>
                            </div>
                        </div>
